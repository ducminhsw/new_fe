                                ...
                                headerLeft: () => {
                                    return (<View style={styles.chatViewHeaderLeftContainer}>
                                        ...
                                        <View style={{ padding: 10 }}>
                                            <Image style={styles.image} source={{ uri: 'https://cdn2.downdetector.com/static/uploads/logo/fb-messenger.png' }} />
                                        </View>
                                    </View>)
                                },
                                        ...
                                        <View style={styles.chatViewHeaderLeftContainer}>
                                            ...
                                            <View style={styles.chatViewProPicContainer}>
                                                <Image
                                                    ...
                                                    source={{ uri: 'https://cdn2.downdetector.com/static/uploads/logo/fb-messenger.png' }}
                                                />
                                            </View>
                                            <View>
